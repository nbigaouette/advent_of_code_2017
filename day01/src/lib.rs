...
pub fn aoc_day01(input: &str, skip: usize) -> u32 {
    input
        .chars()
        .cycle()
        .skip(skip)
...
pub fn aoc_day01_part_1(input: &str) -> u32 {
    aoc_day01(input, 1)
}

pub fn aoc_day01_part_2(input: &str) -> u32 {
    aoc_day01(input, input.len() / 2)
}
    ...
    mod aoc2017 {
        mod day01 {
            ...
            fn part_1_example_01_1122() {
                let input = "1122";
                let expected = 3;
                let to_check = aoc_day01_part_1(input);
            ...
            #[test]
            fn part_2_example_01_1212() {
                let input = "1212";
                let expected = 6;
                let to_check = aoc_day01_part_2(input);

                assert_eq!(expected, to_check);
            }

            #[test]
            fn part_2_example_02_1221() {
                let input = "1221";
                let expected = 0;
                let to_check = aoc_day01_part_2(input);
            ...
            fn part_1_solution() {
                ...
                let expected = 1177;
                let to_check = aoc_day01_part_1(PUZZLE_INPUT);
            ...
            fn part_2_solution() {
                const PUZZLE_INPUT: &'static str = include_str!("../input");
                let expected = 1060;
                let to_check = aoc_day01_part_2(PUZZLE_INPUT);
